...
public class AdminController {
    ...
    public String editStudent(StudentCustom studentCustom) throws Exception {
        studentService.updataById(studentCustom.getUserid(), studentCustom); /*重定向*/
        return "redirect:/admin/showStudent.action";
    }
    ...
    public String addTeacher(TeacherCustom teacherCustom, Model model) throws Exception {
        ...
        userloginService.save(userlogin);
        //重定向
        return "redirect:/admin/showTeacher.action";
    }
    ...
    public String showCourse(Model model, Integer page) throws Exception {
        List<CourseCustom> list = null; /*页码对象*/
        PagingVO pagingVO = new PagingVO(); /*设置总页数*/
    ...
    public String addCourse(CourseCustom courseCustom, Model model) throws Exception {
        ...
        return "redirect:/admin/showCourse.action";
    }

    // 修改教师信息页面显示
    @RequestMapping(value = "/editCourse", method = {RequestMethod.GET})
    public String editCourseUI(Integer id, Model model) throws Exception {
        if (id == null) return "redirect:/admin/showCourse.action";
        CourseCustom courseCustom = courseService.findById(id);
        if (courseCustom == null) throw new CustomException("未找到该课程");
        List<TeacherCustom> list = teacherService.findAll();
        List<College> collegeList = collegeService.finAll();
        model.addAttribute("teacherList", list);
        model.addAttribute("collegeList", collegeList);
